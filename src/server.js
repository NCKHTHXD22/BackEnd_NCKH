...
const LAKE_SPECS_SEED = [
    ...
    { lake_id:7,  name:'Sông Bung 4A', river:'Sông Bung',           province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC:130.0, MNDBT:138.0, MNGC:139.0, crest:140.0, total_volume: 20, dead_volume:  5, flood_volume:  8, turbines:1, capacity_mw: 16, turbine_efficiency:0.88, tailwater_elev: 80.0, design_head:52.0, max_turbine_flow: 40, spillway_crest_elev:134.0, spillway_width:12, spillway_coef:0.42, min_env_flow:1.0 },
    { lake_id:8,  name:'Sông Bung 5',  river:'Sông Bung',           province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC:175.0, MNDBT:185.0, MNGC:186.5, crest:187.5, total_volume:100, dead_volume: 28, flood_volume: 30, turbines:2, capacity_mw: 50, turbine_efficiency:0.88, tailwater_elev:130.0, design_head:49.0, max_turbine_flow:130, spillway_crest_elev:180.0, spillway_width:20, spillway_coef:0.42, min_env_flow:2.0 },
    { lake_id:9,  name:'Sông Bung 2',  river:'Sông Bung',           province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC:330.0, MNDBT:340.0, MNGC:342.0, crest:343.0, total_volume:250, dead_volume: 70, flood_volume: 60, turbines:2, capacity_mw:100, turbine_efficiency:0.88, tailwater_elev:265.0, design_head:69.0, max_turbine_flow:185, spillway_crest_elev:336.0, spillway_width:24, spillway_coef:0.42, min_env_flow:2.5 },
    { lake_id:11, name:'Sông Bung 6',  river:'Sông Bung',           province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC: 93.0, MNDBT:100.0, MNGC:101.0, crest:102.0, total_volume: 50, dead_volume: 12, flood_volume: 15, turbines:1, capacity_mw: 30, turbine_efficiency:0.88, tailwater_elev: 55.0, design_head:40.0, max_turbine_flow: 95, spillway_crest_elev: 96.0, spillway_width:12, spillway_coef:0.42, min_env_flow:1.5 },
    { lake_id:12, name:'Sông Tranh 3', river:'Sông Tranh (Thu Bồn)', province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC: 60.0, MNDBT: 65.0, MNGC: 66.0, crest: 67.0, total_volume: 60, dead_volume: 15, flood_volume: 18, turbines:2, capacity_mw: 60, turbine_efficiency:0.88, tailwater_elev: 25.0, design_head:35.0, max_turbine_flow:215, spillway_crest_elev: 61.0, spillway_width:20, spillway_coef:0.42, min_env_flow:2.0 },
    { lake_id:13, name:'Za Hung',       river:'Sông Za Hung',        province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC:150.0, MNDBT:160.0, MNGC:161.5, crest:162.5, total_volume:130, dead_volume: 35, flood_volume: 40, turbines:2, capacity_mw: 90, turbine_efficiency:0.88, tailwater_elev: 90.0, design_head:64.0, max_turbine_flow:175, spillway_crest_elev:155.0, spillway_width:22, spillway_coef:0.42, min_env_flow:2.0 },
    { lake_id:14, name:'Đắk Mi 3',     river:'Sông Đắk Mi',         province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC:340.0, MNDBT:352.0, MNGC:353.5, crest:354.5, total_volume: 70, dead_volume: 18, flood_volume: 20, turbines:1, capacity_mw: 30, turbine_efficiency:0.88, tailwater_elev:270.0, design_head:76.0, max_turbine_flow: 50, spillway_crest_elev:348.0, spillway_width:12, spillway_coef:0.42, min_env_flow:1.5 },
    { lake_id:15, name:'Khe Diên',      river:'Sông Vu Gia',         province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC: 18.0, MNDBT: 24.0, MNGC: 25.0, crest: 26.0, total_volume: 35, dead_volume:  8, flood_volume: 10, turbines:1, capacity_mw: 30, turbine_efficiency:0.88, tailwater_elev:  5.0, design_head:17.0, max_turbine_flow:225, spillway_crest_elev: 21.0, spillway_width:30, spillway_coef:0.42, min_env_flow:2.0 },
    { lake_id:16, name:'Sông Côn 2',   river:'Sông Côn',             province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC:320.0, MNDBT:334.0, MNGC:335.5, crest:336.5, total_volume: 90, dead_volume: 22, flood_volume: 25, turbines:2, capacity_mw: 60, turbine_efficiency:0.88, tailwater_elev:252.0, design_head:76.0, max_turbine_flow:100, spillway_crest_elev:330.0, spillway_width:20, spillway_coef:0.42, min_env_flow:1.5 },
    { lake_id:17, name:'Sông Tranh 4', river:'Sông Tranh (Thu Bồn)', province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC: 53.0, MNDBT: 58.0, MNGC: 59.0, crest: 60.0, total_volume: 40, dead_volume: 10, flood_volume: 12, turbines:1, capacity_mw: 40, turbine_efficiency:0.88, tailwater_elev: 20.0, design_head:34.0, max_turbine_flow:150, spillway_crest_elev: 55.0, spillway_width:20, spillway_coef:0.42, min_env_flow:1.5 },
    { lake_id:19, name:'Đắk Mi 4C',    river:'Sông Đắk Mi',         province:'Quảng Nam', regulation_doc:'QĐ 471/QĐ-TTg (2016)', MNC:153.0, MNDBT:162.0, MNGC:163.0, crest:164.0, total_volume: 45, dead_volume: 12, flood_volume: 15, turbines:1, capacity_mw: 35, turbine_efficiency:0.88, tailwater_elev:100.0, design_head:57.0, max_turbine_flow: 75, spillway_crest_elev:158.0, spillway_width:12, spillway_coef:0.42, min_env_flow:1.5 },
];
