...
/* ===== MAP HỒ → TRẠM ===== */
const MAP = {
  1: ['ef74db45-c9d6-4469-951c-1c1181244c5b'],// K có dữ liệu
  2: ['34e4a9ab-551e-48ec-9e8a-c6db736920de'],// Không có dữ liệu
  3: ['ef74db45-c9d6-4469-951c-1c1181244c5b'],// Không có dữ liệu
  4: ['afa681b5-2759-11ec-8ef9-06552145a11a'],// Không có dữ liệu
  ...
  12: ['afb382ed-2759-11ec-8ef9-06552145a11a'],  // Tiên Lãnh
  13: ['ef74db45-c9d6-4469-951c-1c1181244c5b'], // K có dữ liệu
  14: ['afb39de3-2759-11ec-8ef9-06552145a11a'], // Phước Công
  15: [
