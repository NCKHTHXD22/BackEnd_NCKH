        ...
        <div className="relative w-full h-screen overflow-hidden bg-gray-100 font-sans">
            ...
            <div className="absolute bottom-4 left-0 right-0 z-[1000] flex flex-col md:flex-row justify-between items-end px-2 md:px-10 pointer-events-none gap-2">
                ...
                <div className="w-full md:flex-1 max-w-4xl flex items-center gap-2 pointer-events-auto">
                    <button className="bg-white text-red-600 rounded-full w-11 h-11 shadow-lg shadow-black/20 border border-white hover:bg-red-50 hover:scale-105 transition-all flex items-center justify-center shrink-0">
                        <FaPlay className="ml-1" />
                    </button>
                    <div className="flex-1 bg-gradient-to-r from-[#0c1a42]/90 to-[#16348a]/85 backdrop-blur-md p-2 md:p-3 rounded-2xl text-white shadow-xl shadow-black/20 text-xs border border-white/10">
                        <div className="relative pt-6 px-1">
                            <div className="absolute top-0 left-0 bg-[#f0a63f] text-white px-2.5 py-0.5 rounded-full text-[10px] sm:text-xs font-bold whitespace-nowrap shadow-sm">
                                {new Date().toLocaleDateString('vi-VN', { weekday: 'long', day: '2-digit', month: '2-digit', year: 'numeric', hour: '2-digit', minute: '2-digit' })}
                            </div>
                            <input type="range" className="w-full h-1 bg-white/90 rounded-full appearance-none outline-none cursor-pointer mt-1" defaultValue={0} />
                ...
                {/* Legend */}
                <div className="bg-gradient-to-br from-[#0c1a42]/90 to-[#16348a]/85 backdrop-blur-md text-white rounded-2xl p-2 text-[10px] w-full md:w-80 shadow-xl shadow-black/20 pointer-events-auto mt-2 md:mt-0 border border-white/10">
